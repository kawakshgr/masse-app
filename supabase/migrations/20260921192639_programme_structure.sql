...
grant select, insert, update, delete on public.programmes, public.programme_weeks, public.sessions, public.session_exercises, public.assignments to authenticated, service_role;
