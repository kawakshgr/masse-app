    ...
    <section className="glass rounded-r3 p-4">
      ...
      >
        ...
        <button
          ...
          className="h-9 shrink-0 rounded-r2 cta px-4 text-[13px] font-semibold text-[var(--on-accent)] disabled:opacity-50"
        >
          ...
          {results.map((candidate) => (
            ...
            >
              ...
              <form action={importFood} className="shrink-0">
                ...
                <button
                  type="submit"
                  className="rounded-rp border border-[var(--edge)] bg-[var(--glass2)] px-3 py-1 text-[11px] font-semibold text-[var(--ink2)]"
                >
                  {t("import")}
                </button>
              </form>
