...
/*
 * The client's tab bar, the iPhone's tabs in the iPhone's order, as the
 * coach's top bar is: one floating glass capsule, icons, and the current tab
 * opened out to its name in capitals. Cycle only exists for a client who
 * asked for it. No messaging tab: she and her coach talk on WhatsApp.
 */
              ...
              <Link
                ...
                className={
                  active
                    ...
                    : "flex size-12 items-center justify-center rounded-full text-[var(--ink2)]"
                }
